 ...
 *
 * It does NOT fetch its own `/api/orders` — that would add a network hop and
 * drop the request's auth context. The route handler exists for external
 * callers; the page shares the layer beneath it.
 */
    ...
    return (
      <main className="mx-auto max-w-2xl p-8">
        <p className="text-sm text-neutral-600">
          Not signed in. Wire up <code>lib/session.ts</code>, or set{" "}
          <code>DEV_SESSION_USER_ID</code> in <code>.env</code>.
        </p>
      </main>
    );
  }
